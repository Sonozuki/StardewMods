...
namespace BarkingUpTheRightTree.Models.Converted
{
    ...
    public class CustomTree
    {
        ...
        *********/
        ...
        public CustomTree(int id, string name, Texture2D texture, TapperTimedProduct tappedProduct, int woodId, bool dropsSap, int seedId, int requiredToolLevel, List<SeasonalTimedProduct> shakingProducts, List<string> includeIfModIsPresent, List<string> excludeIfModIsPresent, TimedProduct barkProduct, float unfertilisedGrowthChance, float fertilisedGrowthChance)
        {
            Id = id;

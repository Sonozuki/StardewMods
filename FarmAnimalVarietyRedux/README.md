...
3. Create a sub folder (inside each animal folder) for assets (see final result below for reference).
4. Create a **shopdisplay.png** image and add to the respective animal folder. NOTE: the images must be called **shopdisplay.png**. This should be **32px x 16px**
...
The names for the images have to be exactly the same as in the **content.json** below with each **Baby** or **Harvested** concatenated on the front (obvoisly depending on if the sheet is for baby or harvested varients).
            ...
            },
            {
                ...
                "Produce": {
                    "AllSeasons": {
                        "Products": [
                            {
                                "Id": "SpaceChase0.JsonAssets:GetObjectId:TigerFur",
                                "HarvestType": 2,
                                "ToolName": null,
                                "HeartsRequired": 0
                            }
                        ...
                        "DeluxeProducts": [
                            {   
                                "Id": "SpaceChase0.JsonAssets:GetObjectId:TigerFang",
                                "HarvestType": 2,
                                "ToolName": null,
                                "HeartsRequired": 0
                            }
...
## Compatibility
Farm Animal Variety Redux is compatible with Stardew Valley 1.4+ on Windows/Mac/Linus, both single player and multiplayer. To view reported bugs visit both the issues on this repo and bug reports on [Nexus](https://www.nexusmods.com/stardewvalley/mods/?tab=bugs).

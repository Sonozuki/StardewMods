...
namespace BetterCrabPots
{
    class ModConfig
    {
        ...
        public Dictionary<int, int> WhatCanBeFoundInFarmLandAsTrash { get; set; } = new Dictionary<int, int>() { { 168, 1 }, { 169, 1 }, { 170, 1 }, { 171, 1 }, { 172, 1 } };
        public Dictionary<int, int> WhatCanBeFoundInCindersapForest { get; set; } = new Dictionary<int, int>() { { 716, 1 }, { 721, 1 }, { 722, 1 } };
        public Dictionary<int, int> WhatCanBeFoundInCindersapForestAsTrash { get; set; } = new Dictionary<int, int>() { { 168, 1 }, { 169, 1 }, { 170, 1 }, { 171, 1 }, { 172, 1 } };
        public Dictionary<int, int> WhatCanBeFoundInMountainsLake { get; set; } = new Dictionary<int, int>() { { 716, 1 }, { 721, 1 }, { 722, 1 } };
        public Dictionary<int, int> WhatCanBeFoundInMountainsLakeAsTrash { get; set; } = new Dictionary<int, int>() { { 168, 1 }, { 169, 1 }, { 170, 1 }, { 171, 1 }, { 172, 1 } };
        public Dictionary<int, int> WhatCanBeFoundInTown { get; set; } = new Dictionary<int, int>() { { 716, 1 }, { 721, 1 }, { 722, 1 } };
        public Dictionary<int, int> WhatCanBeFoundInTownAsTrash { get; set; } = new Dictionary<int, int>() { { 168, 1 }, { 169, 1 }, { 170, 1 }, { 171, 1 }, { 172, 1 } };
